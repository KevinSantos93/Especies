...
Según los resultados, solo el caudal y la dureza se dsitribuyen normalmente, ya que tienen p valores menores que 0.05 (p < 0.05).
...
Al realizar el test de Anderson-Darling, se comprueba que el caudal y la dureza son las unicas variables que se distribuyen normamlente.
...
Se observa qye la primera componente explica el 55.65% de la varianza total, mientras que las primeras tres explican el 95.64%
...
Gráfico de las variables. Las que correlacionan positivamente se encuentran en el mismo cuadrante de la gráfica. Las que correlacionan negativamente se encuentran en cuadrantes opuestos. Por ejemplo, caudal correlacionan negativamente con la dureza y el oxigeno disuelto.

El color representa la contribuciCón a la componente. Las variables de la temperatura y e pH son las que menos contribuyen a las componentes.
```{r}
...
Se observa que la primera componente explica el 53.09% de la varianza total, mientras que las primeras tres explican el 94.62%.
Obsérvese que dos componentes explican mas de 3 cuartas partes de la varianza total
...
Gráfico de las variables. Las que correlacionan positivamente se encuentran en el mismo cuadrante de la gráfica. Las que correlacionan negativamente se encuentran en cuadrantes opuestos.

El color representa la contribución a la componente. La variable del oxigeno disuelto es la que menos contribuye a las componentes.
```{r}
...
Se observa qye la primera componente explica el 51.12% de la varianza total, mientras que las primeras tres explican el 93.59%
...
El color representa la contribuciC3n a la componente. Laa variable del oxigeno disuelto es la que menos contribuye a las componentes.
```{r}
